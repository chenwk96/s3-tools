...
var Object = &cobra.Command{
	...
	Example: "go run s3.go putfile2object <Param>\t upload in the form of a file\n" +
		"go run s3.go put2object <Param>\t 	 upload in the form of bytes\n" +
		"go run s3.go download_object <Param>\t download file from remote server\n" +
		"go run s3.go copy object <Param>\t copy a object to another bucket'object\n" +
